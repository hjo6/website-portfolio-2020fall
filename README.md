...
The last major addition to the website was some code that I've worked on during this semester. I had listed above in my baseline goals that I wanted to split my Projects page into two separate pages: one for school projects and the other for personal projects. While I feel I had enough to justify the separation of the pages, I also felt that there was enough content on just the one page to justify using the horizontal/vertical tab system I implemented a couple of weeks ago. The code I chose to add to the portfolio is from my Capstone project and my Intro to Computer Vision courses; I feel that these are 2 of the courses where I really excelled in with my work so I felt that it was important to add at least a handful of programs to showcase my experience.

I had been talking about how I was unsure of how to present the code in my repository, but I ultimately decided that taking a screenshot of the code and posting the image would be the most practical way of showcasing the work. I took screenshots using my computer, then used GIMP to edit and combine the screenshots into a single image. I also posted the expected output for all of the programs to showcase my results from running them. I linked to a GitHub repository for my Intro to Computer Vision course, but my capstone code repository is set to private, so I just showcased what code I wrote for our capstone website.

Overall, I would say I'm extremely satisfied with how my website/consolidation project turned out. There are some tiny features that still would be nice to be implemented (pretty much all of my stretch goals) and some small fixes I would like to figure out (how to make the closing tabs always have a fluid animation). I feel that I was able to hit all of the major goals I set from the first proposal onward, and I'm proud with how I was able to create my own color palettes and design for the website.
